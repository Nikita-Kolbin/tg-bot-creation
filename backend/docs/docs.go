...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.BotsListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BotUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/bot/{bot_id}/product/{product_id}/cart": {
            "post": {
                "consumes": [
                    "application/json"
                ],
